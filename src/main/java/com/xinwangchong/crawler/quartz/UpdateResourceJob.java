...
import com.xinwangchong.crawler.crawler.JidongCrawlerData;
...
public class UpdateResourceJob {
	...
	private void crawlerJidongWork(ResourceService rs,int pages,CrawlerData crawlerData) throws Exception{
		crawlerData.crawler(rs, pages);
		if (deleteTime!=null) {
			rs.removeResource(deleteTime, Constant.JI_DONG_VIDEO);
		}
	}
}
